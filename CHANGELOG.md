...
- Temporal flexible emission simulation: Provide yearly emission maps with daily emission line chart ([6](https://gitlab.heigit.org/climate-action/plugins/heating-emissions/-/issues/6))
