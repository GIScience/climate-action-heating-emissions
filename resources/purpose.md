...
- life cycle greenhouse gas emissions, which include all the greenhouse gases (carbon dioxide, methane, F-gases, etc.) emitted in order to generate heat. This includes direct emissions from buildings, but also emissions at power plants that generate electricity to power heat pumps, or heat water delivered to residences through district heating networks.
