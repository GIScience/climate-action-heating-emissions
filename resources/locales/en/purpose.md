...
This tool shows not just how much buildings emit, but also why; enabling targeted interventions in the neighborhoods where renovation or fuel-switching can have the greatest effect.
...
However, since that carbon dioxide is biogenic instead of fossil (that is, it was captured into wood via photosynthesis in the recent past), their life cycle emissions are very low.
